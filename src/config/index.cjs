...
module.exports = {
    ...
    tasks: [
        ...
        { topic: '🇨🇳疯猫丑狗不正常🇨🇳', action: 'sendInfo', info: `-----❤温馨提醒❤-----\n距离下班还有约两个小时！！！坚持！！`, date: '0 0 16 * * 1-5' },
        { topic: '🇨🇳疯猫丑狗不正常🇨🇳', action: 'sendInfo', info: `-----❤温馨提醒❤-----\n距离下班还有约一个小时！！！喜大普奔！！`, date: '0 0 17 * * 1-5' },
        { topic: '🇨🇳疯猫丑狗不正常🇨🇳', action: 'sendInfo', info: `-----❤温馨提醒❤-----\n上个厕所，准备快下班啦！！！`, date: '0 55 17 * * 1-4' },
        { topic: '🇨🇳疯猫丑狗不正常🇨🇳', action: 'sendInfo', info: `-----❤温馨提醒❤-----\n今天周五，有什么事下周一再说！！！\n准备摸鱼下班！！`, date: '0 30 17 * * 5' },
        { topic: '🇨🇳疯猫丑狗不正常🇨🇳', action: 'sendInfo', info: `-----⚠注意⚠-----\n别熬夜了！！快睡觉！！`, date: '0 0 23 * * *' },

        { topic: '多喝水早睡夸夸群', action: 'sendWeather',username:"一曈", city: "常州", date: '0 0 7 * * *' },
        { topic: '多喝水早睡夸夸群', action: 'sendInfo', info: `-----⚠注意⚠-----\n放下二郎腿！！！！\n喝水去！！！！`, date: '0 30 9,10,14,15 * * 1-5' },
        { topic: '多喝水早睡夸夸群', action: 'sendInfo', info: `-----❤温馨提醒❤-----\n上个厕所，准备快下班啦！！！`, date: '0 30 16 * * 1-5' },
        { topic: '多喝水早睡夸夸群', action: 'sendInfo', info: `-----⚠注意⚠-----\n快洗漱！！！！！！！`, date: '0 0 22 * * 1-5' },
        { topic: '多喝水早睡夸夸群', action: 'sendInfo', info: `-------⚠注意⚠-------\n快准备睡觉！！！！！！！\n记得打开forest种树！！`, date: '0 0 23 * * 1-5' },
    ],
}
